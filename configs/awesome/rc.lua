...
mytextclock = wibox.widget.textclock(" %a %b %d, %l:%M%P", 15) --12 hr clock
...
--    awful.key({ }, "#233", function () awful.util.spawn("xbacklight -inc 10") end),
    ...
    awful.key({ modkey }, "xx", awesome.quit,
...
-- }}}
--
awful.spawn.with_shell('nitrogen --set-zoom-fill --random ~/dotfiles/configs/wallpapers')
awful.spawn.with_shell('compton') --terminal transparentcy
beautiful.useless_gap = 5 -- gap between windows
awful.util.spawn("dmenu_run") --pop up dmenu when awm starts
